-- 0012_room_live_now_patron.sql
--
-- Bumps the room_live_now RPC to return each smoker's `is_premium`
-- flag so the doorway sheet's live-now cards can render the gold
-- Patron ring around their avatars. Same SECURITY DEFINER + ghost
-- filter as 0011 — no privacy regressions.
